...
<body>
        ...
        <nav class="links">
            <ul>
                ...
                <?php if(isset($_SESSION["loggedin"])&&$_SESSION["loggedin"]===true):?>
                    <a href="parkmap.php">Parkmap</a>
                <?php else:?>
                    <a href="login.html">Parkmap</a>
                <?php endif; ?>
                </li>
                <li>
                <?php if(isset($_SESSION["loggedin"])&&$_SESSION["loggedin"]===true):?>
                    <a href="bookhistory.php">Booking</a>
                <?php else:?>
                <a href="login.html">Booking</a></li>
                <?php endif; ?>
                </li>
            </ul>
        </nav>
 ...
 <div class="main">
   ...
   <div class="rightone">
    ...
    <?php if(isset($_SESSION["loggedin"])&&$_SESSION["loggedin"]===true):?>
        <button class="bookyours"><a href="checkslots.php"> Check Slots</a></button>
    <?php else:?>
