...
$checkUser="SELECT username from reservationdetails WHERE username='$currentUser'";
$query=mysqli_query($conn,$checkUser);
if(mysqli_num_rows($query)>0){
    echo "<script>
    if (alert('You already booked a slot! No more booking allowed.')) {
        window.location.href = 'index.php';
    } else {
        window.location.href = 'index.php'; // Fallback redirect if user dismisses alert
    }
...
<html lang="en">
<head>
    <link rel="stylesheet" href="../css/checkslots.css">
...
<div class="main">
    ...
    <script src="../js/checkslots.js"></script>
</body>
</html>
<?php
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if(($selectedslot!="")&&!empty($starttime)&&!empty($endtime)){
        ...
        $sql3="INSERT INTO reservationdetails(slotno,username,starttime,endtime,slotdate) VALUES('$selectedslot','$username','$starttime','$endtime','$slotdate')";
